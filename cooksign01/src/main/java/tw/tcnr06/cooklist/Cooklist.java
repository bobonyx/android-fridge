...
public class Cooklist extends AppCompatActivity implements ViewSwitcher.ViewFactory,AdapterView.OnItemClickListener {
    ...
    private Integer[]thumbImgArr={
            R.drawable.cimg01,R.drawable.cimg02,R.drawable.cimg03,R.drawable.cimg04,
            R.drawable.cimg05,R.drawable.cimg06,R.drawable.cimg07,R.drawable.cimg08,
            R.drawable.cimg09,R.drawable.cimg10,R.drawable.cimg11,R.drawable.cimg12,
    };
    ...
    private Integer[]cbookArr={R.drawable.cbook01,R.drawable.cbook02,R.drawable.cbook03,R.drawable.cbook04,R.drawable.cbook05,R.drawable.cbook06
                                                    ,R.drawable.cbook07,R.drawable.cbook08,R.drawable.cbook09,R.drawable.cbook10,R.drawable.cbook11,R.drawable.cbook12};
    ...
    private void setupViewComponent() {
        ...
        //設定新增食譜BTN監聽
        cedit_btn=(ImageButton)findViewById(R.id.ch_b101);
    ...
    private View.OnClickListener clookbtn01On = new View.OnClickListener() {
        @Override
        public void onClick(View v) {

            intent.setClass(Cooklist.this, Copen01.class);
...
//            startActivity(i);
    ...
    private View.OnClickListener cedit_btnOn = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            intent.setClass(Cooklist.this, CEdit.class);
...
//String aa="等一下";
        ...
        gridview02.setHorizontalSpacing(1); // 間距
...
//String aa="等一下";
        ...
        //設置監聽
        //gridview03.setOnClickListener(gridbtn03);
    }

//    private GridView.OnClickListener gridbtn03 = new GridView.OnClickListener() {
//        @Override
//        public void onClick(View v) {
//
//
...
//    };
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        //傳送食譜大圖片
        //CbookImgObj cb_obj = new CbookImgObj();
        //bundle.putParcelable("Img",cbookArr[position]);


        //bundle.putSerializable("CbookImgObj ", cb_obj);
