...
public class ShoplistMain extends AppCompatActivity implements View.OnClickListener {
    String TAG = "tcnr02=";
    private TextView count_t;
    private EditText b_id, b_title, b_text, b_note;
    ...
    private String[] MYCOLUMN = new String[]{"id", "title", "text", "note"};
    int tcount;
    ...
    private static final String DB_TABLE = "shoplist";
    private static final int DBversion = 1;
    //-----------------
    private String sqlctl;
    private String tid;
    private String s_id;
    private String tnoteess;
...
//                -------------抓取遠端資料庫設定執行續------------------------------
    ...
    private void setupViewComponent() {
        ...
        b_title = (EditText) findViewById(R.id.edtName);
        b_text = (EditText) findViewById(R.id.edtGrp);
...
//        btEnd.setOnClickListener(this);
    ...
    private Runnable updateTimer = new Runnable() {
        ...
        public void run() {
            ...
            //-------------------------------------------------------------------------------
            ++update_time;
            nowtime.setText(getString(R.string.now_time) +  " (" + (update_time) + "次)" + str );
            //------ 宣告鈴聲 ---------------------------
...
//                showip = NetwordDetect();
    ...
    private ListView.OnItemClickListener listviewOnItemClkLis = new ListView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            String s = ((TextView) view.findViewById(R.id.txtView))
                    .getText()
                    .toString();
            bsubTitle.setText(s);
        }
...
//                break;
            ...
            case R.id.btnupdate:
                ...
                ttext = b_text.getText().toString().trim();
...
//                }
            ...
            case R.id.btIdDel:
                ...
                myAltDlg.getWindow().setBackgroundDrawableResource(R.color.Purple);
...
//---------------------------------------------------
            ...
            case R.id.btnquery: //按下查詢鈕
                ...
                tnote = b_note.getText().toString().trim();
                msg = null;
                recSet = dbHper.getRecSet_query_shoplist(ttitle, ttext, tnote);
...
//                //----------------------------------
    ...
    private void mysql_update() {
        ...
        ttitle = b_title.getText().toString().trim();
        ttext = b_text.getText().toString().trim();
        tnoteess = b_note.getText().toString().trim();

        ArrayList<String> nameValuePairs = new ArrayList<>();
        nameValuePairs.add(s_id);
        nameValuePairs.add(ttitle);
        nameValuePairs.add(ttext);
...
//-----------------------------------------------
        String result = Cook_DBConnector.executeUpdate_shop(nameValuePairs);
...
//-----------------------------------------------
        String result = Cook_DBConnector.executeInsert(nameValuePairs);
//-----------------------------------------------
    }
...
//-----------------------------------------------
        String result = Cook_DBConnector.executeDelet_shop(nameValuePairs);
...
//-----------------------------
    ...
    private ContentValues FillRec() { //
        ...
        contVal.put("title", b_title.getText().toString());
        contVal.put("text", b_text.getText().toString());
        contVal.put("note", b_note.getText().toString());
        return contVal;
    }

    // 讀取MySQL 資料
    private void dbmysql() {
        sqlctl = "SELECT * FROM shoplist ORDER BY id ASC";
        ArrayList<String> nameValuePairs = new ArrayList<>();
        nameValuePairs.add(sqlctl);
        try {
...
//--------------------------------------------------------
                ...
                ser_msg = "主機資料庫無資料(code:" + Cook_DBConnector.httpstate + ") ";
...
//**************************************************
    private void chk_httpstate() {
        ...
        if (Cook_DBConnector.httpstate == 200) {
            //            ser_msg = "遠端資料庫成功(code:" + DBConnector.httpstate + ") ";
            ser_msg = "連線成功";
...
//            ser_msg = "遠端資料庫異常(code:" + DBConnector.httpstate + ") ";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.shoplist_main, menu);
        this.menu = menu;
//        ========================
