...
public class Fridge extends AppCompatActivity implements View.OnClickListener {
    ...
    int autotime = 100;// 要幾秒的時間 更新匯入MySQL資料
    //------------------------------
    ...
    private int years02,days02,month02;
    // --------------------------------------------------------
...
//--------------------------------
            ...
            case R.id.btIdel:
                // 刪除一筆
                MyAlertDialog aldDial = new MyAlertDialog(Fridge.this);
...
//-----------------------------------------------
        String result = DBConnector.executeUpdate_fri( nameValuePairs);
//-----------------------------------------------
    }
...
//-----------------------------------------------
        String result = DBConnector.executeInsert_fri(nameValuePairs);  //真正執行新增
//-----------------------------------------------
    }
...
//-----------------------------------------------
        String result = DBConnector.executeDelet_fri(nameValuePairs);   //執行刪除
//-----------------------------------------------
    }
...
//        super.onBackPressed();
    ...
    private void dbmysql() {
        ...
        nameValuePairs.add(sqlctl);
        try {
            String result = DBConnector.executeQuery_fri(nameValuePairs);
            //==========================================
